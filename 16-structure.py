...
# Use structure 2.3.4 to determine admixture
# By Jean P. Elbers
...
Command:
cd InDir = /work/jelber2/immunome_urtd/combined/popgen
1.Run structure
...
File Info:
InDir = /work/jelber2/immunome_urtd/combined/popgen
...
~/scripts/immunome_urtd/16-structure.py mainparams.test.0*
