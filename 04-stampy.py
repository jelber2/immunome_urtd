...
Command:
cd InDir = /work/jelber2/immunome_urtd/run1/bwa-alignment
...
Directory info:
InDir = /work/jelber2/immunome_urtd/run1/bwa-alignment
Input Files = Sample-singlesANDmerged.bwa.sam
              Sample-paired.bwa.sam
OutDir = /work/jelber2/immunome_urtd/run1/stampy-alignment
