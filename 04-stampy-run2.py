...
04-stampy-run2.py version 1.0

Command:
cd InDir = /work/jelber2/immunome_urtd/run2/bwa-alignment
...
Directory info:
InDir = /work/jelber2/immunome_urtd/run2/bwa-alignment
Input Files = Sample-singlesANDmerged.bwa.sam
              Sample-paired.bwa.sam
OutDir = /work/jelber2/immunome_urtd/run2/stampy-alignment
