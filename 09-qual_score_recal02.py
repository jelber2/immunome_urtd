...
OutDir = /work/jelber2/immunome_urtd/combined/call-SNPs-recal02
Output Files = Sample-recal02.bam


Usage (execute following code in InDir):

find . -name '*-recal01.bam' -not -name 'ALL-samples-*' -exec ~/scripts/immunome_urtd/09-qual_score_recal02.py {} \;
...
if len(sys.argv)<2:
    ...
    for InFileName in FileList: # do the following steps for each file in the inputstream
        ...
        WallTime = "01:00:00"
        LogOut = "/work/jelber2/immunome_urtd/combined/call-SNPs-recal02"
        LogMerge = "oe"
