...
Command:
cd InDir = /work/jelber2/immunome_urtd/combined/call-SNPs-recal02
...
File Info
InDir = /work/jelber2/immunome_urtd/combined/call-SNPs-recal02
Input Files =
       Sample-recal02.bam
       ../call-SNPs-recal02/ALL-samples-recal02-Q30-SNPs.vcf
OutDir = /work/jelber2/immunome_urtd/combined/call-SNPs-recal03
Output Files = Sample-recal03.bam


Usage (execute following code in InDir):

find . -name '*-recal02.bam' -not -name 'ALL-samples-*' -exec ~/scripts/immunome_urtd/11-qual_score_recal03.py {} \;
...
if len(sys.argv)<2:
    ...
    for InFileName in FileList: # do the following steps for each file in the inputstream
        ...
        WallTime = "01:00:00"
        LogOut = "/work/jelber2/immunome_urtd/combined/call-SNPs-recal03"
        LogMerge = "oe"
