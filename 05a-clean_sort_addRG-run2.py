...
05a-clean_sort_addRG-run2.py - version 1.0

Command:
cd InDir = /work/jelber2/immunome_urtd/run2/stampy-alignment
...
(1)/work/jelber2/immunome_urtd/run2/stampy-alignment
(2)                                /clean-sort-addRG

InDir = /work/jelber2/immunome_urtd/run2/stampy-alignment
...
if len(sys.argv)<2:
    ...
    for InFileName in FileList: # so samtools grabs only the file names (i.e., Samples)
        ...
        WallTime = "00:30:00"
        LogOut = "/work/jelber2/immunome_urtd/run2/clean-sort-addRG"
        LogMerge = "oe"
